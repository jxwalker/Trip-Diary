                ...
                if "activities" in day and isinstance(day["activities"], list):
                    ...
                    for activity in day["activities"]:
                        if isinstance(activity, dict):
                            ...
                            # Coerce string activities into minimal dict with map url
                            coerced = {
                                "name": activity,
                                "map_url": self.generate_maps_url(activity, "")
                            }
                            new_activities.append(coerced)
