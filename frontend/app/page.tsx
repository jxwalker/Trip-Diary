...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Get actual restaurants and attractions with real-time data - no placeholders",
        ...
        <div className="container mx-auto text-center">
          ...
          >
            <Badge className="mb-4 px-4 py-1 text-sm bg-sky-100 text-sky-700 border-sky-200">
              ...
              AI-Powered Real Recommendations
            </Badge>
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              ...
              actual attractions, and a complete day-by-day itinerary with AI-powered insights.
            </p>
